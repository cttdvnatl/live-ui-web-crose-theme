            ...
            {prop.data.map((history) => {
                return (
                    <div class={history.significance}>
                        ...
                        <h2>{history.title}</h2>
                        <p><img alt="history" class="history-image" src={history.imgsrc} height={history.imgheight} width={history.imgwidth}></img>{history.description}</p>
