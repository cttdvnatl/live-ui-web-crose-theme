...
//Auth dispatch
export const authenticate = (dispatch, credentials) => axios.post('https://hvmatlbackend.com/authentication', credentials)
...
//Get WeeklyNews
export const getWeeklyNews = (dispatch, from, to, token) => axios.get('https://hvmatlbackend.com/weeklyNews', {
        headers: {
...
//Get Carousel Slides
export const getSlides = (dispatch, date, token) => axios.get('https://hvmatlbackend.com/carousel', {
        headers: {
            'Authorization': `Bearer ${token}`
        },
        params:{
