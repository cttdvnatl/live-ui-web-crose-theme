...
const ContactPage = () => (
  <div>
    ...
    <div className="help-desk-section section-padding-0-100">
      <div className="container">
        <div className="row">
          <div className="col-12 text-center">
            <hr />
            <div className="section-heading">
              <h2>OR</h2>
              <p>Contact a particular Department.</p>
            </div>
            <a
              href="https://app.smartsheet.com/b/form/961442de069a498c81bfc6a5e73399c4"
              className="crose-btn mt-15"
            >
              Help Desk
            </a>
